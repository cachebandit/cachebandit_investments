        ...
        <div class="mover-row" data-symbol="${escapeHtml(symbol)}">
            ...
            <div class="mover-company-cell">
                <button class="company-info-btn"
                        ...
                        data-atr="${escapeHtml(stock.ATR || 'N/A')}"
                        data-rsi="${escapeHtml(stock.RSI || 'N/A')}"
                        data-stop-price="${escapeHtml(stock.stop_price || '')}"
                        data-anchor-price="${escapeHtml(stock.anchor_price || '')}"
